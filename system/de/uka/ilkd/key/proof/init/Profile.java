...
public interface Profile {
    ...
    */
    ...
    /**
     * @returns the ProgramBlockProvider, which is used to parse the content of
     *          modalities by the KeYParser
     */
    ProgramBlockProvider getProgramBlockProvider();

    /**
     * @param namespaces
     *            The set of namespaces active
     * @param services
     *            The services currently used
     * @returns the ProgramBlockProvider, which is used to parse the content of
     *          modalities by the KeYParser
     */
    ProgramBlockProvider getProgramBlockProvider(Services services,
