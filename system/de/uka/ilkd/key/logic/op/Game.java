 ...
 */
public class Game extends Op implements NonRigid {

    private static final HashMap<String, Game> nameMap = 
        new HashMap<String, Game>(10);
     ...
     */
    Game(Name name, int arity) {
	super(name);
	this.arity = arity;
	nameMap.put(name.toString(), this);
    }

    public static HashMap<String, Game> getNameMap() {
	return nameMap;
    }
