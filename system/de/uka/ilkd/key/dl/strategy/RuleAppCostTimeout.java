...
public class RuleAppCostTimeout implements RuleAppCost {
    ...
    /**
     * checks whether an attempt of proving for time timeout is superior to the given (previous attempt) cost.
     * Returns the superior cost, or null if still unknown.
     */
    public static RuleAppCost superior(long timeout, RuleAppCost cost) {
        ...
        throw new IllegalArgumentException("Don't know how to compare with " + cost);
    }
