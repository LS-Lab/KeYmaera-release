 ...
 */
public class ToLessConjunct extends AbstractDLMetaOperator {

    public static final Name NAME = new Name("#toLessConjunct");

    public ToLessConjunct() {
        super(NAME, 1);
    }
    ...
    public Term calculate(Term term, SVInstantiations svInst, Services services) { 	
        ...
        {	return	MathSolverManager.getCurrentSimplifier().
            		toLessConjunct(term.sub(0), services.getNamespaces());
        } 
        catch (Exception e) {
