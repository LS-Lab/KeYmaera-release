...
public enum EPropertyConstant {
       ...
       DLOPTIONS_SIMPLIFY_BEFORE_REDUCE("[DLOptions]simplifyBeforeReduce", "simplify before QE","simplify formulas passed to quantifier eliminator of the arithmetic solver (careful check advised! May cause QE to not terminate if variable order on universal closure is affected!)", "DL Properties"),
