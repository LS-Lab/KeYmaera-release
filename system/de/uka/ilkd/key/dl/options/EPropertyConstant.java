...
public enum EPropertyConstant {
	    ...
	    DLOPTIONS_DIFFSAT_TIMEOUT("[DLOptions]diffSatTimeout","initial DiffSat timeout", "the timeout used in the first iteration of the DiffSat strategy (in seconds)", "DL Properties"),
	    DLOPTIONS_LOOPSAT_TIMEOUT("[DLOptions]loopSatTimeout", "initial LoopSat timeout", "the timeout used in the first iteration of the LoopSat strategy (in seconds)", "DL Properties"),	  
	    ...
	    DLOPTIONS_SIMPLIFY_BEFORE_REDUCE("[DLOptions]simplifyBeforeReduce", "simplify before reduce","simplify formulas passed to the reduce function of the arithmetic solver", "DL Properties"),
	    DLOPTIONS_SIMPLIFY_AFTER_REDUCE("[DLOptions]simplifyAfterReduce", "simplify after reduce","simplify the results generated by the reduce function of the arithmetic solver", "DL Properties"),
	    DLOPTIONS_APPLY_UPDATES_TO_MODALITIES("[DLOptions]applyToModality", "update modalities", "apply updates to modalites e.g. to get simpler solutions for differential equations", "DL Properties"),
	    ...
	    DLOPTIONS_QUANTIFIER_ELIMINATOR("[DLOptions]quantifierEliminator", "real arithmetic solver","select the solver for real arithmetic that should be used to eliminate quantifiers", "DL Properties"),
	    ...
	    DLOPTIONS_APPLY_LOCAL_REDUCE("[DLOptions]applyLocalReduce", "local reductions","try to eliminate quantifiers in single first-order formulas (before trying to reduce the complete sequent)", "DL Properties"),
	    DLOPTIONS_APPLY_LOCAL_SIMPLIFY("[DLOptions]applyLocalSimplify", "local simplifications", "try to simplify single first-order subformulas (before trying to reduce the complete sequent)", "DL Properties"),
	    DLOPTIONS_APPLY_GLOBAL_REDUCE("[DLOptions]applyGlobalReduce", "global reductions","try to reduce the complete sequent if possible", "DL Properties"),
	    ...
	    DLOPTIONS_GROEBNER_BASIS_CALCULATOR("[DLOptions]groebnerBasisCalculator", "equation solver", "select the solver for handling equational theories, e.g., by Groebner bases", "DL Properties"),
	    ...
	    DLOPTIONS_BUILT_IN_ARITHMETIC("[DLOptions]BuiltInArithmetic", "built-in arithmetic", "select to which degree built-in arithmetic rules should be used", "DL Properties"),
	    ...
	    HOL_OPTIONS_QUANTIFIER_ELIMINATION_METHOD("[HOLLightOptions]qeMethod", "QE Method", "The quantifier elimination method to use","HOL Light Properties"),	
