...
public enum EPropertyConstant {
	    ...
	    DLOPTIONS_SIMPLIFY_BEFORE_REDUCE("[DLOptions]simplifyBeforeReduce", "simplify before QE","simplify formulas passed to quantifier eliminator of the arithmetic solver", "DL Properties"),
	    DLOPTIONS_SIMPLIFY_AFTER_REDUCE("[DLOptions]simplifyAfterReduce", "simplify after QE","simplify the results generated by the quantifier eliminator of the arithmetic solver", "DL Properties"),
	    ...
	    DLOPTIONS_USE_ODE_IND_FIN_METHODS("[DLOptions]useODEIndFinMethods", "Use Ind/Fin Methods of ODESolver", "Check this option to use the DiffInd/DiffFin methods implemented in the ODE Solver instead of directly in KeYmaera.", "DL Properties"), 
