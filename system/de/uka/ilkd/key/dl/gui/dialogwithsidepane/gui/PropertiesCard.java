...
import de.uka.ilkd.key.dl.gui.dialogwithsidepane.gui.options.MathematicaSuffixFinder;
import de.uka.ilkd.key.dl.gui.dialogwithsidepane.propertyconfigurations.EPropertyConfigurations;
...
public class PropertiesCard implements ActionListener, ChangeListener { 
	...
	m.setMathematicaPrefixFinder(groupCardMap.get("Mathematica Properties"));
    }
