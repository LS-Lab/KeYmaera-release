...
public class ApplyOnModality extends AbstractUpdateRule {
    ...
    protected static LRUCache<Term, HashSet<Object>> protectedVarsCache = 
     ...
     */
    protected boolean protectedLocation(Location loc, 
     ...
     */
    protected HashSet<Object> collectProgramVariables(Term target, Services services) {
