 ...
 */
public class CheckApplyEqSymFeature extends BinaryTacletAppFeature {

    public static final Feature INSTANCE = new CheckApplyEqSymFeature();

    private CheckApplyEqSymFeature () {}
...
//               && equationIsDirected ( ifInst, p_app.constraint() )
    ...
    private boolean isNotSelfApplication(PosInOccurrence pos,
        ...
        if ( it.getChild () == 1 )
        // we don't allow rewriting in the right term of the equation
                return false;
