...
import de.uka.ilkd.key.pp.LogicPrinter.PosTableStringBackend;
import de.uka.ilkd.key.pp.LogicPrinter.StackEntry;
...
public LogicPrinterHTML(ProgramPrinter prgPrinter,
		...
		layouter          = new LayouterHtml(backend,2);
...
public LogicPrinterHTML(ProgramPrinter prgPrinter,
 ...
 protected LayouterHtml mark(Object o) {
     if (pure) {
             return null;
     } else {
             return (LayouterHtml) layouter.mark(o);
     }
 }
